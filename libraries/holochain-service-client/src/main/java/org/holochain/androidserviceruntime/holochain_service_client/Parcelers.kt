...
object AppInfoFfiParceler : Parceler<AppInfoFfi> {
    ...
    override fun AppInfoFfi.write(parcel: Parcel, flags: Int) {
    ...
    private fun writeCellInfoMap(parcel: Parcel, map: Map<String, List<CellInfoFfi>>, flags: Int) {
        ...
        map.forEach { (key, value) ->
            ...
            value.forEach { cellInfo ->
                CellInfoFfiParcel(cellInfo).writeToParcel(parcel, flags)
            }
        }
    }
}
...
object AppInfoStatusFfiParceler : Parceler<AppInfoStatusFfi> {
    override fun create(parcel: Parcel): AppInfoStatusFfi {
        return when (parcel.readInt()) {
            1 -> AppInfoStatusFfi.Paused(parcelableCreator<PausedAppReasonFfiParcel>().createFromParcel(parcel).inner)
            2 -> AppInfoStatusFfi.Disabled(parcelableCreator<DisabledAppReasonFfiParcel>().createFromParcel(parcel).inner)
    ...
    override fun AppInfoStatusFfi.write(parcel: Parcel, flags: Int) {
        when (this) {
...
object AppAuthenticationTokenIssuedFfiParceler : Parceler<AppAuthenticationTokenIssuedFfi> {
    override fun create(parcel: Parcel): AppAuthenticationTokenIssuedFfi {
        return AppAuthenticationTokenIssuedFfi(
            token = parcel.createByteArray() ?: ByteArray(0),
            expiresAt = if (parcel.readInt() == 1) parcel.readLong() else null
        )
    }

    override fun AppAuthenticationTokenIssuedFfi.write(parcel: Parcel, flags: Int) {
...
object AppAuthFfiParceler : Parceler<AppAuthFfi> {
    override fun create(parcel: Parcel): AppAuthFfi {
        return AppAuthFfi(
            authentication = parcelableCreator<AppAuthenticationTokenIssuedFfiParcel>().createFromParcel(parcel).inner,
            port = parcel.readInt().toUShort()
        )
    }

    override fun AppAuthFfi.write(parcel: Parcel, flags: Int) {
...
object ZomeCallUnsignedFfiParceler : Parceler<ZomeCallUnsignedFfi> {
    ...
    override fun ZomeCallUnsignedFfi.write(parcel: Parcel, flags: Int) {
...
object ZomeCallFfiParceler : Parceler<ZomeCallFfi> {
    ...
    override fun ZomeCallFfi.write(parcel: Parcel, flags: Int) {
        CellIdFfiParcel(cellId).writeToParcel(parcel, flags)
        parcel.writeString(zomeName)
        parcel.writeString(fnName)
        parcel.writeByteArray(payload)
...
object CellIdFfiParceler : Parceler<CellIdFfi> {
    ...
    override fun CellIdFfi.write(parcel: Parcel, flags: Int) {
...
object CellInfoFfiParceler : Parceler<CellInfoFfi> {
    override fun create(parcel: Parcel): CellInfoFfi {
        ...
        return when (i) {
            1 -> CellInfoFfi.Provisioned(parcelableCreator<ProvisionedCellFfiParcel>().createFromParcel(parcel).inner)
            2 -> CellInfoFfi.Cloned(parcelableCreator<ClonedCellFfiParcel>().createFromParcel(parcel).inner)
    ...
    override fun CellInfoFfi.write(parcel: Parcel, flags: Int) {
        when (this) {
...
object ProvisionedCellFfiParceler : Parceler<ProvisionedCellFfi> {
    ...
    override fun ProvisionedCellFfi.write(parcel: Parcel, flags: Int) {
        CellIdFfiParcel(cellId).writeToParcel(parcel, flags)
...
object ClonedCellFfiParceler : Parceler<ClonedCellFfi> {
    ...
    override fun ClonedCellFfi.write(parcel: Parcel, flags: Int) {
        CellIdFfiParcel(cellId).writeToParcel(parcel, flags)
...
object StemCellFfiParceler : Parceler<StemCellFfi> {
    ...
    override fun StemCellFfi.write(parcel: Parcel, flags: Int) {
        parcel.writeByteArray(originalDnaHash)
        DnaModifiersFfiParcel(dnaModifiers).writeToParcel(parcel, flags)
        if (name != null) {
            parcel.writeInt(1)
...
object DnaModifiersFfiParceler : Parceler<DnaModifiersFfi> {
    ...
    override fun DnaModifiersFfi.write(parcel: Parcel, flags: Int) {
...
object DurationFfiParceler : Parceler<DurationFfi> {
    override fun create(parcel: Parcel): DurationFfi {
        return DurationFfi(
            secs = parcel.readLong().toULong(),
            nanos = parcel.readInt().toUInt()
        )
    }

    override fun DurationFfi.write(parcel: Parcel, flags: Int) {
...
object PausedAppReasonFfiParceler : Parceler<PausedAppReasonFfi> {
    ...
    override fun PausedAppReasonFfi.write(parcel: Parcel, flags: Int) {
        when (this) {
...
object DisabledAppReasonFfiParceler : Parceler<DisabledAppReasonFfi> {
    ...
    override fun DisabledAppReasonFfi.write(parcel: Parcel, flags: Int) {
        when (this) {
