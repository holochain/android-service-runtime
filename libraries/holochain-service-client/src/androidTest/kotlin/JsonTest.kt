...
class JsonTest {
    ...
    fun testAppInfoStatusFfiDisabled() {
        ...
        assertEquals(res.getJSONObject("status").getJSONObject("reason").getString("type"), "NeverStarted")
    }
    ...
    fun testCellInfoFfi() {
        ...
        val value = MyObj(info = CellInfoFfi.Provisioned(
            ProvisionedCellFfi(
                cellId = CellIdFfi(
    ...
    fun testRoleSettingsFfi() {
        ...
        val value = MyObj(rolesettings = RoleSettingsFfi.Provisioned(
