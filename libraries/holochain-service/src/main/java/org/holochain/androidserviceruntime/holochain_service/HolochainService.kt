...
class HolochainService : Service() {
  ...
  private inner class AdminBinder : IHolochainServiceAdmin.Stub() {
    ...
    /// Uninstall an app
    override fun uninstallApp(callback: IHolochainServiceCallback, installedAppId: String) {
    ...
    override fun enableApp(callback: IHolochainServiceCallback, installedAppId: String) {
      Log.d(TAG, "enableApp")
      this.expectAuthorized()
    ...
    override fun disableApp(callback: IHolochainServiceCallback, installedAppId: String) {
    ...
    /// Is app installed
    override fun isAppInstalled(callback: IHolochainServiceCallback, installedAppId: String) {
    ...
    override fun ensureAppWebsocket(callback: IHolochainServiceCallback, installedAppId: String) {
    ...
    /// Sign a zome call
    override fun signZomeCall(callback: IHolochainServiceCallback, req: ZomeCallUnsignedFfiParcel) {
  ...
  private inner class AppBinder(private val installedAppId: String) : IHolochainServiceApp.Stub() {
    ...
    private fun expectAuthorized(installedAppId: String) {
      ...
      if (!isAuthorized) {
        ...
        // throw UnauthorizedException("Package is not authorized to access the AppBinder
        // clientPackageName=$clientPackageName installedAppId=$installedAppId")
      }
    }
  }
  ...
  private fun startForeground() {
    try {
      ...
      val notification =
          NotificationCompat.Builder(this, "HolochainServiceChannel")
