//[client](../../../index.md)/[org.holochain.androidserviceruntime.client](../index.md)/[InstallAppCallbackDeferred](index.md)

# InstallAppCallbackDeferred

[androidJvm]\
class [InstallAppCallbackDeferred](index.md) : [IHolochainServiceCallbackStubDeferred](../-i-holochain-service-callback-stub-deferred/index.md)&lt;[AppInfoFfi](../-app-info-ffi/index.md)&gt;

## Constructors

| | |
|---|---|
| [InstallAppCallbackDeferred](-install-app-callback-deferred.md) | [androidJvm]<br>constructor() |
...
| [await](../-i-holochain-service-callback-stub-deferred/await.md) | [androidJvm]<br>suspend fun [await](../-i-holochain-service-callback-stub-deferred/await.md)(): [AppInfoFfi](../-app-info-ffi/index.md) |
...
| [installApp](install-app.md) | [androidJvm]<br>open override fun [installApp](install-app.md)(response: [AppInfoFfiParcel](../-app-info-ffi-parcel/index.md)) |
