//[client](../../../index.md)/[org.holochain.androidserviceruntime.client](../index.md)/[EnableAppCallbackDeferred](index.md)

# EnableAppCallbackDeferred

[androidJvm]\
class [EnableAppCallbackDeferred](index.md) : [IHolochainServiceCallbackStubDeferred](../-i-holochain-service-callback-stub-deferred/index.md)&lt;[AppInfoFfi](../-app-info-ffi/index.md)&gt;

## Constructors

| | |
|---|---|
| [EnableAppCallbackDeferred](-enable-app-callback-deferred.md) | [androidJvm]<br>constructor() |
...
| [enableApp](enable-app.md) | [androidJvm]<br>open override fun [enableApp](enable-app.md)(response: [AppInfoFfiParcel](../-app-info-ffi-parcel/index.md)) |
