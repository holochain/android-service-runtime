//[client](../../../index.md)/[org.holochain.androidserviceruntime.client](../index.md)/[UninstallAppCallbackDeferred](index.md)

# UninstallAppCallbackDeferred

[androidJvm]\
class [UninstallAppCallbackDeferred](index.md) : [IHolochainServiceCallbackStubDeferred](../-i-holochain-service-callback-stub-deferred/index.md)&lt;[Unit](https://kotlinlang.org/api/core/kotlin-stdlib/kotlin/-unit/index.html)&gt;

## Constructors

| | |
|---|---|
| [UninstallAppCallbackDeferred](-uninstall-app-callback-deferred.md) | [androidJvm]<br>constructor() |
...
| [uninstallApp](uninstall-app.md) | [androidJvm]<br>open override fun [uninstallApp](uninstall-app.md)() |